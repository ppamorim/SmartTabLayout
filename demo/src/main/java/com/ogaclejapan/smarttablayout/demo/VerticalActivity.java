...
public class VerticalActivity extends ActionBarActivity {

  private static final String KEY_DEMO = "VerticalActivity";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    VerticalSmartTabLayout viewPagerTab = (VerticalSmartTabLayout) findViewById(R.id.viewpagertab);
