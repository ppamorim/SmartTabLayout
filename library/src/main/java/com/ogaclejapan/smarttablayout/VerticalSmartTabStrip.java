...
public class VerticalSmartTabStrip extends LinearLayout {
  ...
  private VerticalSmartTabLayout.TabColorizer customTabColorizer;

  VerticalSmartTabStrip(Context context, AttributeSet attrs) {
    super(context);
  ...
  void setCustomTabColorizer(VerticalSmartTabLayout.TabColorizer customTabColorizer) {
  ...
  VerticalSmartTabLayout.TabColorizer getTabColorizer() {
  ...
  protected void onDraw(Canvas canvas) {
    ...
    final VerticalSmartTabLayout.TabColorizer tabColorizer = getTabColorizer();
  ...
  private static class SimpleTabColorizer implements VerticalSmartTabLayout.TabColorizer {
